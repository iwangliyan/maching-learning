# -*- coding: utf-8 -*-
"""
Created on Fri May 25 12:00:24 2018
...
#    
#    df1['body_temp'] = df1.body_temp.apply(lambda x: int(x))
#    df1['temp'] = df1.temp.apply(lambda x: int(x))
