...
# 读取数据
path_registered = 'E:/学习/研究生1/创新竞赛/2018年算法赛/data/rules/registered_count10_11_不完整.csv'
path_casual = 'E:/学习/研究生1/创新竞赛/2018年算法赛/data/rules/casual_count10_11_不完整.csv'
...
# 删除10月11号之前的数据
train_registered = train_registered.drop(train_registered[(train_registered['month'] == 10) & (train_registered['day'] < 11)].index).reset_index(drop=True)
train_casual = train_casual.drop(train_casual[(train_casual['month'] == 10) & (train_casual['day'] < 11)].index).reset_index(drop=True)
...
train_full.to_csv('E:/学习/研究生1/创新竞赛/2018年算法赛/data/rules/train_10_11完整时间人流量_count_registered.csv', index=False)