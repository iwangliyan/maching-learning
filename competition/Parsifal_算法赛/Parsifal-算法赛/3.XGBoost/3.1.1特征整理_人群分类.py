...
path_test = 'E:/学习/研究生1/创新竞赛/2018年算法赛/data/rules/12月test完整时间序列.csv'
# X_train_original = pd.read_csv(path_train)
X_test_original = pd.read_csv(path_test)
X_test_original.columns = ['time', 'location']
path_train = 'E:/学习/研究生1/创新竞赛/2018年算法赛/data/rules/train_10_11完整时间人流量_count_registered.csv'  # time location registered casual
train = pd.read_csv(path_train)
print(train.head(3))
print(len(train), len(X_test_original))
...
train.pop('location')
train.insert(6, 'location', temp_location)
temp_flow = train['registered']
train.pop('registered')
train.insert(6, 'registered', temp_flow)
temp_flow = train['casual']
train.pop('casual')
train.insert(6, 'casual', temp_flow)
train.pop('time')
print(train.head(3))
...
# test整理完毕，开始一起添加特征
y_train_registered = X_train_original.pop('registered')
y_train_casual = X_train_original.pop('casual')
...
# 分割训练集和测试集合
train = train_test.iloc[0:40392, :]
test = train_test.iloc[40392:, :]
train['registered'] = y_train_registered
train['casual'] = y_train_casual
print(train.head(3))
print(test.head(3))
print(len(train), len(test))
train.to_csv('E:/学习/研究生1/创新竞赛/2018年算法赛/data/xgboost/train_featured_人群分类.csv', index=False)
test.to_csv('E:/学习/研究生1/创新竞赛/2018年算法赛/data/xgboost/test_featured_人群分类.csv', index=False)
