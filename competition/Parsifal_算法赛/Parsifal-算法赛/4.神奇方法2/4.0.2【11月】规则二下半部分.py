...
# 读取数据
path_test_half = 'E:/学习/研究生1/创新竞赛/2018年算法赛/data/rules/10_11规则二_6周.csv'
...
test_half.columns = ['flow', 'location1', 'hour1', 'weekday1']
...
test_full.to_csv('E:/学习/研究生1/创新竞赛/2018年算法赛/data/rules/12月规则二_全时间6.csv', index=False)
