...
# 读取数据
path_test_half = 'E:/学习/研究生1/创新竞赛/2018年算法赛/data/rules/9_10规则一_6周_人群分类.csv'
...
test_half.columns = ['location1', 'weekday1', 'hour1', 'flow']
...
test_full.to_csv('E:/学习/研究生1/创新竞赛/2018年算法赛/data/rules/规则一_全时间6_人群分类.csv', index=False)
