...
path_train2 = "E:/学习/研究生1/创新竞赛/2018年算法赛/data/months1_10/09.csv"
...
train['LT'] = train['time'] + '/' + train['location']
...
train_count.to_csv('E:/学习/研究生1/创新竞赛/2018年算法赛/data/rules/train_count9_10.csv', index=True)
