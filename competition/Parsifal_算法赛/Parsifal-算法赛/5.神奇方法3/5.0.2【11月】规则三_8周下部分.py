...
# 读取数据
path_test_half = 'E:/学习/研究生1/创新竞赛/2018年算法赛/data/rules/10_11规则三_8周.csv'
...
test_half.columns = ['flow', 'weekday1', 'hour1', 'location1']
...
test_full.to_csv('E:/学习/研究生1/创新竞赛/2018年算法赛/data/rules/12月规则三_全时间8.csv', index=False)
